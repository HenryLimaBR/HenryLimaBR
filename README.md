...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -20; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 100vw; opacity: 0.2; background: url('https://github.com/HenryLimaBR/HenryLimaBR/blob/main/bg.png?raw=true');]{x0000}$}
```
